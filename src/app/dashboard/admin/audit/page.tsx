...
const auditLogs = [
  { id: 1, timestamp: "2023-10-27 10:00 AM", user: "admin@edublock.com", action: "REVOKE_ACCESS", details: "Revoked access for principal 'principal@school.edu'" },
  ...
  { id: 4, timestamp: "2023-10-26 01:10 PM", user: "admin@edublock.com", action: "CREATE_PRINCIPAL", details: "Created principal 'new.principal@innovate.edu'" },
